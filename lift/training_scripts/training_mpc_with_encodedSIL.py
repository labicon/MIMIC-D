...
# Load expert data
expert_data = np.load("TrainingDataDiffusion2/expert_actions_newslower_20.npy")
expert_data1 = expert_data[:, :, :7]
expert_data2 = expert_data[:, :, 7:14]

# Load and process image data for each arm
# Assuming the image latents are 128-dimensional for each arm
expert_images_latents_arm1 = np.load("TrainingDataDiffusion2/arm1_images_latents.npy")
expert_images_latents_arm2 = np.load("TrainingDataDiffusion2/arm2_images_latents.npy")
