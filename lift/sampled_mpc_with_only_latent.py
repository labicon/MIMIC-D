...
class PolicyPlayer:
    ...
    def load_model(self, expert_data1, expert_data2, obs_init1, obs_init2, obs, image_latents_initial_arm1, image_latents_initial_arm2, state_dim = 7, action_dim = 7):
        ...
        action_cond_ode.load(extra="_lift_mpc_P20E1_imageonlyLATENT_rotvec_separatenorm_dual_camera_fixed_arm")
    ...
    def get_demo(self, seed, cond_idx, H=25, T=700):
        ...
        # Loading
        expert_data = np.load("TrainingDataDiffusion_fixed_arm/expert_actions_newslower_20.npy")
        expert_data1 = expert_data[:, :, :7]
        expert_data2 = expert_data[:, :, 7:14]

        # Load original image sequences BEFORE creating MPC dataset
        expert_images_latents_arm1_orig = np.load("TrainingDataDiffusion_fixed_arm/arm1_images_latents.npy")
        expert_images_latents_arm2_orig = np.load("TrainingDataDiffusion_fixed_arm/arm2_images_latents.npy")
        ...
        with open("TrainingDataDiffusion_fixed_arm/pot_start_newslower_20.npy", "rb") as f:
            obs = np.load(f)
