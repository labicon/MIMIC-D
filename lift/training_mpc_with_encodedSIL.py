...
expert_images_latents_arm1 = np.load("TrainingDataDiffusion_image+state/arm1_images_latents.npy")
expert_images_latents_arm2 = np.load("TrainingDataDiffusion_image+state/arm2_images_latents.npy")
...
# Training
end="_lift_mpc_P15E1_encodedImageAndState_rotvec_separatenorm_dual_camera"
action_cond_ode = Conditional_ODE(env, [attr_dim1, attr_dim2], [sigma_data1, sigma_data2], device=device, N=100, lin_scale=160, n_models = 2, **model_size)
