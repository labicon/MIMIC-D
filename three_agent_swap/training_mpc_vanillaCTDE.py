...
# Training
end = "_P25E1_400demos_06noise_vanillaCTDE"
...
# Sampling
try:
    init1_list = np.load("temp/init1_list.npy")
    init2_list = np.load("temp/init2_list.npy")
    init3_list = np.load("temp/init3_list.npy")
    final1_list = np.load("temp/final1_list.npy")
    final2_list = np.load("temp/final2_list.npy")
    final3_list = np.load("temp/final3_list.npy")
...
for i in range(100):
    ...
    np.save("sampled_trajs/mpc_P25E1_400demos_06demonoise_06samplenoise_200N_vettedinitfinal_vanillaCTDE/traj1_%s.npy" % i, planned_traj1)

    planned_traj2 = planned_trajs[1] * std + mean
    np.save("sampled_trajs/mpc_P25E1_400demos_06demonoise_06samplenoise_200N_vettedinitfinal_vanillaCTDE/traj2_%s.npy" % i, planned_traj2)

    planned_traj3 = planned_trajs[2] * std + mean
    np.save("sampled_trajs/mpc_P25E1_400demos_06demonoise_06samplenoise_200N_vettedinitfinal_vanillaCTDE/traj3_%s.npy" % i, planned_traj3)